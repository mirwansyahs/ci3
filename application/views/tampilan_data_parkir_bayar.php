      ...
      <div class="mb-3">
        ...
        <select name="jenis_kendaraan" id="" class="form-control">
          <?php foreach ($this->db->get('kategori')->result() as $key) { ?>
            <option value="<?=$key->id_kategori?>" <?=($key->id_kategori == $data->id_kategori)?'selected':''?>><?=$key->nm_kategori?></option>
          <?php } ?>
        </select>
      </div>
      <div class="mb-3">
        ...
        <input type="text"
          class="form-control" name="jam_masuk" id="" aria-describedby="jam_masuk" placeholder="" value="<?=$data->jam_masuk?>">
      </div>
      <div class="mb-3">
        <label for="" class="form-label">Jam keluar</label>
        <input type="text"
          class="form-control" name="jam_keluar" id="" aria-describedby="jam_keluar" placeholder="" value="<?=$data->jam_keluar?>">
      </div>
      <div class="mb-3">
        <label for="" class="form-label">Harga</label>
        <input type="text"
          class="form-control" name="harga" id="" aria-describedby="harga" placeholder="" value="<?=$data->harga?>">
      </div>
      <div class="mb-3">
        <label for="" class="form-label">Bayar</label>
        <input type="text"
          class="form-control" name="bayar" id="" aria-describedby="bayar" placeholder="" value="">
      </div>
