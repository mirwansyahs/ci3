            ...
            <table class="table table-primary">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>
                            <a name="" id="" class="btn btn-primary" href="<?=base_url()?>index.php/DataAdmin/edit/<?=$value->id_user?>" role="button">Edit</a>
                            <a name="" id="" class="btn btn-danger" href="<?=base_url()?>index.php/DataAdmin/hapus/<?=$value->id_user?>" role="button">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
