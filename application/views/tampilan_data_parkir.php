                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>
                            ...
                            <a name="" id="" class="btn btn-success" href="<?=base_url()?>index.php/DataParkir/keluar_sekarang/<?=$value->id_kendaraan?>" role="button">Keluar Sekarang</a>
                            <?php } ?>
                            <a name="" id="" class="btn btn-primary" href="<?=base_url()?>index.php/DataParkir/edit/<?=$value->id_kendaraan?>" role="button">Edit</a>
                            <a name="" id="" class="btn btn-danger" href="<?=base_url()?>index.php/DataParkir/hapus/<?=$value->id_kendaraan?>" role="button">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
